...
(function (Scratch) {
  ...
  var extensionConfig = {
  	id: "kubohiroyatwhttpreact",
  	slug: "turbowarp-http-server-react",
  	name: "TurboWarp HTTP Server React",
  	description: "Describe React islands from TurboWarp blocks for turbowarp-http-server HTML responses.",
  	author: "Hiroya Kubo",
  	license: "MPL-2.0",
  ...
  var block_definitions_default = {
  	extensionName: "TurboWarp HTTP Server React",
  	blocks: [
  		{
  			"opcode": "registerComponent",
  			"blockType": "COMMAND",
  			"text": "register React component [COMPONENT] from [MODULE]",
  			"description": "Registers a React component name and the browser module that will hydrate it later.",
  			"arguments": {
  				"COMPONENT": {
  					"type": "STRING",
  				...
  				"MODULE": {
  					"type": "STRING",
  					"defaultValue": "/assets/react-islands.js"
  				}
  			}
  		},
  		{
  			"opcode": "reactIsland",
  			"blockType": "REPORTER",
  			"text": "React island [COMPONENT] at [MOUNT_ID] props [PROPS_JSON]",
  			"description": "Returns a JSON mount descriptor for a React island.",
  			"arguments": {
  				"COMPONENT": {
  					"type": "STRING",
  					"defaultValue": "Counter"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "React island HTML [COMPONENT] at [MOUNT_ID] props [PROPS_JSON]",
  			"description": "Returns a safe HTML fragment that marks where a React island should be mounted.",
  			"arguments": {
  				"COMPONENT": {
  					"type": "STRING",
  					"defaultValue": "Counter"
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "React component registry JSON",
  			"description": "Returns the registered React component registry as JSON.",
  			"arguments": {}
  		}
  	]
  };
  ...
  function parsePropsJson(value) {
  	...
  	if (typeof parsed !== "object" || parsed === null || Array.isArray(parsed)) throw new TypeError("React island props must be a JSON object.");
  	return parsed;
  }
  ...
  function validateComponentName(value) {
  	...
  	if (!/^[A-Z][A-Za-z0-9]*(?:[.:/-][A-Z]?[A-Za-z0-9]+)*$/.test(component)) throw new TypeError(`Invalid React component name: ${value}`);
  	return component;
  }
  function validateMountId(value) {
  	const mountId = value.trim();
  	if (!/^[A-Za-z][A-Za-z0-9_-]*$/.test(mountId)) throw new TypeError(`Invalid React island mount ID: ${value}`);
  	return mountId;
  }
  function validateModuleSpecifier(value) {
  	const module = value.trim();
  	if (module.length === 0) throw new TypeError("React component module must be non-empty.");
  	return module;
  }
  ...
  var TurboWarpHttpServerReactExtension = class {
  	constructor() {
  	...
  	registerComponent(args) {
  		this.registry.register(Scratch.Cast.toString(args.COMPONENT), Scratch.Cast.toString(args.MODULE));
  	}
  	reactIsland(args) {
